  ...
  const excelTimbradoDataCto = () => {
    ...
    for (let i = 0; i < ctoFind.activeBornes.length; i++) {
      excelData.push({
        cto: ctoFind.cto,
        borne: i + 1,
        lineIdInicial: formData.lineIdInicial,
        vnoCodeInicial: formData.vnoCodeInicial,
        olt: formData.olt,
        slot: parseInt(formData.slot, 10),
        port: parseInt(formData.port, 10),
        onuInicial: "",
        estadoInicial: formData.estadoInicial,
        onuFinal: parseInt(formData.onuFinal, 10),
        estadoEnCampoInicial: formData.estadoEnCampoInicial,
        estadoEnCampoFinal: formData.estadoEnCampoFinal,
        potenciaAntes: parseInt(formData.potenciaAntes, 10),
        potenciaDespues: parseInt(formData.potenciaDespues, 10),
        potenciaCampo: parseInt(formData.potenciaCampo, 10),
        lineIdFinal: formData.lineIdFinal,
        vnoCodeFinal: formData.vnoCodeFinal,
